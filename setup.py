...
setup(
  ...
  version = 'Working with python 2.6',
  description = 'A simple python http and https webserver',
  author = 'John Andersen',
  author_email = 'johnandersenpdx@gmail.com',
  url = 'https://github.com/pdxjohnny/SimpleHTTPSServer', # use the URL to the github repo
  download_url = 'https://github.com/pdxjohnny/SimpleHTTPSServer/tarball/0.5', # I'll explain this in a second
